        ...
        <div class="table-cell">
            ...
            <div class="container">
                ...
                <p class="lead text-white mb-4">
                    Temukan destinasi wisata terbaik, hotel nyaman, dan pengalaman liburan yang tak terlupakan.
                </p>
...
<main id="main">
    ...
    <section id="work"
        ...
        <div class="container">
            ...
            <!-- Tombol Jelajahi Semua Destinasi -->
            <div class="row mt-4">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="title-box text-center">
                        ...
                        <p class="subtitle-a">
                            Rekomendasi hotel terbaik untuk wisatawan
                        </p>
                ...
                <?php foreach ($hotel as $h) : ?>
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <div class="work-box">
                            ...
                            <a href="<?= base_url('hotel_front/detail/' . $h->hotel_id); ?>">
            ...
            <div class="row mb-5">
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <div class="title-box">
                        ...
                        <p class="subtitle-a">
                            Informasi, event, dan perkembangan wisata terbaru.
                        </p>
            ...
            <div class="row">
                ...
                <div class="col-12 text-center mb-5">
                    ...
                    <p class="statistik-subtitle">
                        Informasi lengkap destinasi, hotel dan berita wisata di Magelang
                    </p>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <div class="stats-card">
                        ...
                        <h2><?= count($destinasi); ?></h2>

                        <h4>Destinasi Wisata</h4>

                        <p>
                            Destinasi wisata terbaik di Kabupaten Magelang
                        </p>
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <div class="stats-card">
                        ...
                        <p>
                            Pilihan hotel dan penginapan nyaman untuk wisatawan
                        </p>
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <div class="stats-card">
                        ...
                        <p>
                            Berita terbaru seputar pariwisata di Magelang
                        </p>
...
=========================== -->
    ...
    <section id="gallery" class="portfolio-mf sect-pt4 route gallery-section">
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <div class="title-box">
                        ...
                        <p class="subtitle-a">
                            ...
                            Dokumentasi keindahan destinasi wisata terbaik
                            Kabupaten Magelang yang siap menginspirasi perjalanan Anda.
                            ...
                            <div class="gallery-card">
                                ...
                                <a href="<?= base_url('uploads/galeri/' . $g->foto); ?>"
                                    ...
                                    <div class="gallery-image">
                                        ...
                                        <img
                                            src="<?= base_url('uploads/galeri/' . $g->foto); ?>"
                                            alt="<?= $g->judul_foto; ?>"
                                            class="img-fluid"
                                            loading="lazy">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7">
                        ...
                        <p>
                            ...
                            panorama alam, budaya, religi, sejarah hingga
                            kuliner terbaik yang telah kami dokumentasikan.

                        </p>

                    </div>

                    <div class="col-lg-3 text-lg-right text-center mt-4 mt-lg-0">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const elements = document.querySelectorAll('.work-box,.service-box,.card-blog');
